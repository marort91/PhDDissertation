...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[scale=0.45]{Figures/HigherDimEigen/AlphaScalarFluxRQ_g=0}
        \caption{Scalar Flux for Energy Group 0}
    \end{subfigure}%
    ~ 
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[scale=0.45]{Figures/HigherDimEigen/AlphaScalarFluxRQ_g=1}
        \caption{Scalar Flux for Energy Group 1}
    \end{subfigure}
%    \caption{Caption place holder}
        \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[scale=0.45]{Figures/HigherDimEigen/AlphaScalarFluxRQ_g=2}
        \caption{Scalar Flux for Energy Group 2}
    \end{subfigure}%
    ~ 
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[scale=0.45]{Figures/HigherDimEigen/AlphaScalarFluxRQ_g=3}
        \caption{Scalar Flux for Energy Group 3}
    \end{subfigure}
        \caption{Scalar Flux for Energy Group}
\end{figure*}
...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[scale=0.45]{Figures/HigherDimEigen/AlphaScalarFluxRQ_g=4}
        \caption{Scalar Flux for Energy Group 4}
    \end{subfigure}%
    ~ 
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[scale=0.45]{Figures/HigherDimEigen/AlphaScalarFluxRQ_g=5}
        \caption{Scalar Flux for Energy Group 5}
    \end{subfigure}
%    \caption{Caption place holder}
        \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[scale=0.45]{Figures/HigherDimEigen/AlphaScalarFluxRQ_g=6}
