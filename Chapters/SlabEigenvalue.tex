...
\begin{table}[!htbp]
	...
	\bottomrule
	\end{tabular}
	\caption{Fissile Material Radius and Shell Thicknesses for Plutonium/Highly Enriched Uranium Mixture Benchmark}
	\label{table:MIX_MET_Dims}
\end{table}

\begin{table}[!htbp]
	\caption{Material Composition for Plutonium/Highly Enriched Uranium Mixture System}
	\label{table:MIX}
		\centering\ra{1.3}
		\begin{tabular}{@{}ccccc@{}}\toprule
			Material Number & Temperature ($^{\circ}$C) & Component & Density (g/cm$^{3}$) & Number Fraction \\ 
...
\begin{table}[!htbp]
	\caption{Calculated Eigenvalues and Transport Sweep Comparisons for Plutonium/Highly Enriched Uranium System}
