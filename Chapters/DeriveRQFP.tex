...
\section{Jacobian of the Rayleigh Quotient Fixed Point Method for Alpha-Eigenvalue Problems}
...
\end{equation}
The Jacobian matrix for ht Rayleigh quotient fixed point method for $k$-effective eigenvalue problems can then be written as
\begin{equation}
