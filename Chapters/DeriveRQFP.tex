...
For all systems, the righthand side of Eq.~\ref{eq:kRQFP} is nonnegative for isotropic scattering and nonnegative $k$ \cite{warsa2004krylov}. The fixed-point form is selected to only require the inversion of the matrix $\mathbf{H}_{\mathbf{z}}$.
