...
\section{Results for Alpha-Eigenvalue Problems}
...
%The Rayleigh quotient method also has monotonically decreasing or increasing eigenvalue iterates for subcritical or supercritical systems, respectively. 
...
\begin{table}[]
    ...
    \subcaption{Infinite Medium Problems}
    %\rowcolors{6}{}{gray!10}
    %\scalebox{0.95}{
    \centering
    \begin{tabular}{*3c}
    ...
    \begin{subtable}{\linewidth}
    %\rowcolors{5}{}{gray!10}
    \subcaption{Finite Medium Problems}
    %\scalebox{0.95}{
    \centering
    \begin{tabular}{*3c}
        \toprule
...
%	\caption{Alpha-Eigenvalue Method Convergence Comparison for Two Problems (Infinite-Medium Supercritical and Finite-Medium Critical)}
	%\caption{\bf Method Comparison of Eigenvalue Relative Change/Eigenvector Residual for Infinite-Medium Supercritical and Critical Alpha-Eigenvalue Problems}
%	\label{fig:aRes}
%\end{figure}

\section{Results for $k$-Effective Eigenvalue Problems}
...
%\begin{table}[]
 %   \centering
   % \caption{\textbf{$k$-Effective Sweep Comparison}}
%\label{table:k}
%\parbox{0.45\linewidth}{
%\begin{subtable}{\linewidth}
%	\begin{centering}
   ...
   % \end{centering}
    ...
    %\begin{tabular}{*3c}
      %  \toprule
        %& \multicolumn{2}{c}{Sweeps} \\
        %\cmidrule(lr){2-3}
        %Problem ID & Rayleigh Quotient & Fission Norm Update \\    
%        ID   & Quotient & Update  \\
        %\midrule
        %PUa-1-0-IN & 41 & 111 \\
        %PUb-1-0-IN & 34 & 96   \\
...
%\begin{subtable}{\linewidth}
 %   \begin{centering}
   % \subcaption{\centering{Finite Medium Problems}}
    %\end{centering}
%    \rowcolors{5}{}{gray!10}
 %   \scalebox{0.95}{
 	%\centering
...
%        \midrule
%        PUa-1-0-SL & 26 & 25 \\
 %       \small PUa-H2O(1)-1-0-SL & 44 & 33      \\
 %       \small PUa-H2O(0.5)-1-0-SL & 27 & 22    \\
 %       PUb-1-0-SL & 28 & 26 \\
%        PUb-1-0-SP & 57 & 51 \\
%        Ua-1-0-SL & 31 & 28 \\
%        \bottomrule
